...
import * as Teamarbeitsroutine from './methods/teamarbeitsroutine.md'
import * as FuenfFingerFeedback from './methods/fuenf-finger-feedback.md'
import * as GewaltfreieKommunikation from './methods/gewaltfreie-kommunikation.md'
