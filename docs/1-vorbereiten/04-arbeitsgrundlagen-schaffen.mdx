...
import * as Teamarbeitsroutine from './methods/04/teamarbeitsroutine.md'
import * as FuenfFingerFeedback from './methods/04/fuenf-finger-feedback.md'
import * as GewaltfreieKommunikation from './methods/04/gewaltfreie-kommunikation.md'
...
<div className="grid grid-cols-1 gap-y-3">
  ...
  <Checkbox id="flipcharts" label="Flipcharts oder großes Papier (z.B. Rückseite von nicht mehr benötigten Postern)" className="md:-translate-x-0 text-sm" />
  <Checkbox id="klebeband" label="Klebeband und Pinnwandnadeln" className="md:-translate-x-0 text-sm" />
  <Checkbox id="post-its" label="Klebezettel (Post-Its) in unterschiedlichen Farben" className="md:-translate-x-0 text-sm" />
  <Checkbox id="flipcharts" label="Flipchartstifte, Filzstifte, Tintenroller" className="md:-translate-x-0 text-sm" />
  <Checkbox id="kreativmaterial" label="Kreativmaterial, z.B. Bildmaterial, Pappkartons, Kostümierungen, Knete etc." className="md:-translate-x-0 text-sm" />
  <Checkbox id="ausdrucke" label="Ausgedruckte Vorlagen, A4 Papier" className="md:-translate-x-0 text-sm" />
  ...
  <Checkbox id="check-in" label="Check In: Beitragsmöglichkeiten aufzeigen" className="md:-translate-x-0 text-sm" />
  <Checkbox id="zusammenarbeit" label="Methodengeleitete Zusammenarbeit" className="md:-translate-x-0 text-sm" />
  <Checkbox id="check-out" label="Check Out: Reflexion" className="md:-translate-x-0 text-sm" />
  <Checkbox id="kurzpraese" label={<><b>Kurzpräsentation</b> bei Einbindung interner Akteure mit Antworten auf folgende Fragen:</>} />
  <Checkbox id="beteiligung-wichtig" label="Warum ist Ihre Beteiligung wichtig?" className="md:-translate-x-0 text-sm" />
  <Checkbox id="beteiligung-warum" label="Woran beteiligen Sie sich?" className="md:-translate-x-0 text-sm" />
  <Checkbox id="rolle" label="In welcher Rolle?" className="md:-translate-x-0 text-sm" />
  <Checkbox id="wie-umgehen" label="Wie gehen wir mit dem Input um?" className="md:-translate-x-0 text-sm" />
  <Checkbox id="entscheidungen" label="Wer trifft weitere Entscheidungen?" className="md:-translate-x-0 text-sm" />
</div>
...
<MethodCard
  ...
  className="mt-5"
  footer={<a href={'./assets/01_prozessverlauf.pdf'} className="!font-normal flex gap-x-1 items-center"><EditIcon className="w-3 h-3 text-inherit" /> PDF-Vorlage</a>}
/>
