...
import * as Teamarbeitsroutine from '@site/src/assets/methods/teamarbeitsroutine.md'
import * as FuenfFingerFeedback from '@site/src/assets/methods/fuenf-finger-feedback.md'
...
<Hint><b>Hinweis:</b> Alle Elemente für einen erfolgreichen Workshop sollten bereits als Budgetplanung im <Link href="/buch/vorbereiten/prozess-planen#prozessverlauf">Prozessverlauf</Link> mitgedacht werden.</Hint>

## Workshop Organisation

<div className="grid grid-cols-1 gap-y-3">
  <Checkbox id="raum" label={<><b>Raum:</b> einladend, ungestört, sicher</>} />
  <Checkbox id="moebel" label={<><b>Möbel:</b> mobile Tische und Stühle, nicht festgeschraubt, am besten Stellwände und Stehtische</>} />
  <Checkbox id="arbeitsmaterial" label={<><b>Arbeitsmaterial:</b> (wenn möglich recyclebar):</>} />
  <Checkbox id="flipcharts" label="Flipcharts oder großes Papier (z.B. Rückseite von nicht mehr benötigten Postern)" className="md:translate-x-7 text-sm" />
  <Checkbox id="klebeband" label="Klebeband und Pinnwandnadeln" className="md:translate-x-7 text-sm" />
  <Checkbox id="post-its" label="Klebezettel (Post-Its) in unterschiedlichen Farben" className="md:translate-x-7 text-sm" />
  <Checkbox id="flipcharts" label="Flipchartstifte, Filzstifte, Tintenroller" className="md:translate-x-7 text-sm" />
  <Checkbox id="kreativmaterial" label="Kreativmaterial, z.B. Bildmaterial, Pappkartons, Kostümierungen, Knete etc." className="md:translate-x-7 text-sm" />
  <Checkbox id="ausdrucke" label="Ausgedruckte Vorlagen, A4 Papier" className="md:translate-x-7 text-sm" />
  <Checkbox id="technik" label={<><b>Technik:</b> Beamer, Pointer, Computer, Kurzzeitwecker und ein Plan B</>} />
  <Checkbox id="verpflegung" label={<><b>Verpflegung:</b> Gehirnfutter wie Nüsse, rohe Schokolade, Obst, Gemüse, viel Wasser</>} />
  <Checkbox id="agenda" label={<><b>Agenda</b> mit Zielen, Zwischenergebnissen, Inhalten, Methoden:</>} />
  <Checkbox id="check-in" label="Check In: Beitragsmöglichkeiten aufzeigen" className="md:translate-x-7 text-sm" />
  <Checkbox id="zusammenarbeit" label="Methodengeleitete Zusammenarbeit" className="md:translate-x-7 text-sm" />
  <Checkbox id="check-out" label="Check Out: Reflexion" className="md:translate-x-7 text-sm" />
  <Checkbox id="kurzpraese" label={<><b>Kurzpräsentation</b> bei Einbindung interner Akteure mit Antworten auf folgende Fragen:</>} />
  <Checkbox id="beteiligung-wichtig" label="Warum ist Ihre Beteiligung wichtig?" className="md:translate-x-7 text-sm" />
  <Checkbox id="beteiligung-warum" label="Woran beteiligen Sie sich?" className="md:translate-x-7 text-sm" />
  <Checkbox id="rolle" label="In welcher Rolle?" className="md:translate-x-7 text-sm" />
  <Checkbox id="wie-umgehen" label="Wie gehen wir mit dem Input um?" className="md:translate-x-7 text-sm" />
  <Checkbox id="entscheidungen" label="Wer trifft weitere Entscheidungen?" className="md:translate-x-7 text-sm" />
</div>
...
<MethodCard
  ...
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_teamarbeitsroutine.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<Hint><b>Hinweis:</b> Die zwei wichtigsten Rollen für gelungene Arbeitstreffen sind die Moderator:in und die Zeitmanager:in. Die Moderator:in leitet nicht das Team, sondern unterstützt das <i>Durchlaufen</i> der Arbeitsroutine und hilft der Gruppe, positive Erfahrungen zu machen. Die Moderator:in ist, wie alle, ein:e Teilnehmer:in des Arbeitstreffens und bringt sich mit eigenen Beiträgen ein. Die Zeitmanager:in unterstützt das Arbeiten in Mikrozeiteinheiten und sorgt für das Beibehalten des Fokus während des Arbeitstreffens.</Hint>
...
<MethodCard
  ...
  imageUrl={"/img/01_hero.svg"}
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_fuenf_finger_feedback.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<Hint><b>Hinweis:</b> Formulierungen wie „<b>Sie</b> haben / <b>Du</b> hast …“ oder „<b>Ihre / Deine</b> Arbeit ist ...“ sollten für ein konstruktives Feedback vermieden werden.</Hint>
...
<MethodCard
  ...
  imageUrl={"/img/01_hero.svg"}
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_gewaltfreie_kommunikation.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<Hint><b>Hinweis:</b> Gewaltfrei zu kommunizieren bedarf ein wenig Übung. Am Anfang hilft es, die wichtigsten Punkte je Schritt zu notieren.</Hint>
