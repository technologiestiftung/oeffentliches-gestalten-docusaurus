...
<MethodCard
  ...
  className="mt-5"
  footer={<Link href={'pathname:///arbeitsblatt/01_teamarbeitsroutine.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<MethodCard
  ...
  imageUrl={"/img/01_hero.svg"}
  className="mt-5"
  footer={<Link href={'pathname:///arbeitsblatt/01_fuenf_finger_feedback.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<MethodCard
  ...
  imageUrl={"/img/01_hero.svg"}
  className="mt-5"
  footer={<Link href={'pathname:///arbeitsblatt/01_gewaltfreie_kommunikation.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
