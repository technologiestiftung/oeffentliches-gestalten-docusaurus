...
<MethodCard
  ...
  className="mt-5"
  footer={<Link href={'pathname:///arbeitsblatt/01_mitspielerinnen_kartieren.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
<MethodCard
  ...
  imageUrl={"/img/01_hero.svg"}
  className="mt-5"
  footer={<Link href={'pathname:///arbeitsblatt/01_teamprofil_und_selbsteinschaetzung.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
