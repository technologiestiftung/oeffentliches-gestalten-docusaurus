...
import * as KulturenWandeln from '@site/src/assets/methods/kulturen-wandeln.md'
...
<MethodSummary
	title={KulturenWandeln.frontMatter.title}
	time={KulturenWandeln.frontMatter.time}
	attributes={KulturenWandeln.frontMatter.attributes}
	footer={KulturenWandeln.frontMatter.note}
>
	<KulturenWandeln.default />
</MethodSummary>

<MethodCard
	title={KulturenWandeln.frontMatter.title}
	surtitle="Arbeitsblatt"
	attributes={[KulturenWandeln.frontMatter.time]}
	imageUrl={"/img/01_hero.svg"}
	className="mt-5"
	footer={
		<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_kulturen_wandeln.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>
			PDF-Vorlage
		</Link>}
/>
