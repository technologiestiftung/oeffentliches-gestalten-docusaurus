...
<Checkbox id="hello" group="greeting" label="Gesprächstermin und -ort vereinbaren" />
...
<Hint>
  <strong>Hinweis:</strong> Im Nachgang zum Termin tauchen häufig weitere wichtige Punkte auf. Ergänzungen sind sinnvoll.
</Hint>
