...
<StagesToc
  ...
  stages={[
    ...
    },
    {
      ...
      description:
        "Auf Schlüsselakteure fokussieren und einen ersten Prototyp erstellen.",
      methods: [
        {
          title: "Archetypen-Profile",
          href: "/buch/erproben/prototypen-erstellen#archetypen-profile",
        },
        {
    ...
    },
    {
      ...
      description:
        "Verstehen, was gut funktioniert und was angepasst oder erneuert werden muss.",
      methods: [
        {
    ...
    {
      title: "Nutzen validieren",
      description:
        "Produkt oder Prozess mit Basisfunktionen konzipieren, um Mehrwert nachweisen zu können.",
      methods: [
        {
          title: "MVP-Canvas",
