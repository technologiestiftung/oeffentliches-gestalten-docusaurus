...
import * as TransformativeAkteursanalyse from '@site/src/assets/methods/transformative-akteursanalyse.md'
...
<img src="/img/02_tree_diagram.svg" className="w-full mx-auto aspect-square" aria-hidden alt={"Diagramm der Baumanalyse"} />
...
<MethodCard
  ...
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/02_akteure_kartieren.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>
...
6. Beziehung zwischen den Schlüsselakteuren in der Mitte abschließend näher beschreiben. Dafür die Vorlage [Schlüsselakteure identifizieren](https://www.oeffentliches-gestalten.de/buch/erkunden/system-akteure-verbinden#schl%C3%BCsselakteure-identifizieren) nutzen.

## Transformative Akteursanalyse

<MethodSummary
	title={TransformativeAkteursanalyse.frontMatter.title}
	time={TransformativeAkteursanalyse.frontMatter.time}
	attributes={TransformativeAkteursanalyse.frontMatter.attributes}
	footer={TransformativeAkteursanalyse.frontMatter.note}
>
	<TransformativeAkteursanalyse.default />
</MethodSummary>

<MethodCard
	title={TransformativeAkteursanalyse.frontMatter.title}
	surtitle="Arbeitsblatt"
	attributes={[TransformativeAkteursanalyse.frontMatter.time]}
	imageUrl={"/img/01_hero.svg"}
	className="mt-5"
	footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/02-transformative-akteursanalyse.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF-Vorlage</Link>}
/>

### Vorgehen

1. Material aus [Mitspieler:innen kartieren](https://www.oeffentliches-gestalten.de/buch/vorbereiten/beteiligte-identifizieren-analysieren#mitspielerinnen-kartieren), [Baumanalyse](https://www.oeffentliches-gestalten.de/buch/erkunden/problemverstaendnis-schaerfen#baumanalyse) und [Schlüsselakteure identifizieren](https://www.oeffentliches-gestalten.de/buch/erkunden/problemverstaendnis-schaerfen#baumanalyse) bereitstellen.
...
**Change Agents** sind Treiber:innen von Wandelprozessen,
die über ihren institutionalisierten Einflussradius hinausgehen, z.B. Beschaffer:innen einer Kommune, die 100% erneuerbare Energien anstrebt.\
...
4. Auswahl priorisieren durch **visuelle Abstimmung**. Akteure mit Bezug auf den Typ des Einflusses auf Transformationen ausdifferenzieren und kategorisieren.