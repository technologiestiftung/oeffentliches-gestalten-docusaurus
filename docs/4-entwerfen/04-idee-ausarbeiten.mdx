...
5. _Knirschszene_ nochmals darstellen und die Beteiligten in der Situation sprechen lassen: Was fühlt sich hier nicht richtig an? Warum? Wie würde es sich besser anfühlen? Warum? Neue, bessere Position einnehmen und einige Minuten experimentieren, bis eine Situation gefunden wird, mit der alle Beteiligten einverstanden sind (10-15 min).

6. Darstellung beenden und Spalte C & D reflektieren: erst allein (2 min) und dann in der Gruppe (10-15 min). Zum Abschluss die wichtigsten Aspekte für die weitere Entwicklung der innovativen Lösung notieren.
