...
Statistics allow us to gain an understanding of whether we should expand or limit the problem focus. Historical data can be helpful in this regard, too. The German Federal Statistical Office collects and processes such data and makes it available for use at *www.destatis.de*.
