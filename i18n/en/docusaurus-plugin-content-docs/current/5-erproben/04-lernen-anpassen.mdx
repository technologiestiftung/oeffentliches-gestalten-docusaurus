...
The analysis of test results is a collective thought process undertaken by everyone on our team. This is not about defending the prototype as developed but about drawing systematic conclusions. From these it will be possible to derive the next steps and concrete measures to improve the solution. The **Analyze Test** (LINK) template makes it easy to structure test outcomes.
...
We get our creative juices flowing again so as to be able to master this potentially sobering task with a sense of curiosity and joy. Before or during the analysis, warm-ups are a great way of lifting our mood. Working in Yes-And mode or a round of **Creative Aikido** (LINK) are ways of providing more light-hearted support as we come to draw conclusions or plan the next steps.
