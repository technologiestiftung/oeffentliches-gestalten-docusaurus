...
<MethodCard
  ...
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_document-outcomes.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF template</Link>}
/>
...
<MethodCard
  ...
  className="mt-5"
  footer={<Link className="text-magenta-500 underline" href={'pathname:///arbeitsblatt/01_myself-and-the-process.pdf'} icon={<EditIcon className="w-3 h-3 text-inherit" />}>PDF template</Link>}
/>